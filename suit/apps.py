...
SUIT_FORM_SIZE_INLINE = (
    SUIT_FORM_SIZE_LABEL,
    "col-xs-12 col-sm-9 col-md-10 form-inline",
)
...
SUIT_FORM_SIZE_XX_LARGE = (
    SUIT_FORM_SIZE_LABEL,
    "col-xs-12 col-sm-9 col-md-10 col-lg-8",
)
SUIT_FORM_SIZE_XXX_LARGE = (
    SUIT_FORM_SIZE_LABEL,
    "col-xs-12 col-sm-9 col-md-10 col-lg-9",
)
...
class DjangoSuitConfig(AppConfig):
    ...
    def setup_model_admin_defaults(self):
        ...
        """
        ModelAdmin.actions_on_top = bool(self.toggle_changelist_top_actions)
